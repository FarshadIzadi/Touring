        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalculatedCosts = table.Column<double>(type: "float", nullable: false),
                    ExtraCosts = table.Column<double>(type: "float", nullable: false),
                    BenefitPerPerson = table.Column<double>(type: "float", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DestinationCountries = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DestinationCities = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TourHeader", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TourHeader_AspNetUsers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TourDetails_Accommodation_AccommodationId",
                        column: x => x.AccommodationId,
                        principalTable: "Accommodation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TourDetails_Activity_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TourDetails_AspNetUsers_TourGuideId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TourDetails_Trip_TripId",
                        column: x => x.TripId,
                        principalTable: "Trip",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourDetails_AccommodationId",
                table: "TourDetails",
                column: "AccommodationId");

            migrationBuilder.CreateIndex(
                name: "IX_TourDetails_ActivityId",
                table: "TourDetails",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_TourDetails_TourGuideId",
                table: "TourDetails",
                column: "TourGuideId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourDetails_TripId",
                table: "TourDetails",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_TourHeader_ManagerId",
                table: "TourHeader",
                column: "ManagerId");
        }
